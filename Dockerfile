...
COPY cas_shared/db/models ./customer_analysis_service/db
COPY cas_shared/db/repository ./customer_analysis_service/db
COPY cas_shared/db/database.py ./customer_analysis_service/db
COPY cas_shared/db/__init__.py ./customer_analysis_service/db
