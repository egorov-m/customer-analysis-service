...
class Review(SQLModel, table=True):
    ...
    href_category_1: str = Field(nullable=False, max_length=200)
    href_category_2: str = Field(nullable=False, max_length=200)
    href_category_3: str = Field(nullable=True, max_length=200)
    href_category_4: str = Field(nullable=True, max_length=200)
